...
<form action="add_work_emplo.php" method="post" accept-charset="utf-8">
  ...
  <td height="4" width="4"    bgcolor="#FEFCAB" colspan="2"><span class="style6">&#269;as za&#269;etka:</span></td>
    ...
    <tr>
      <td bgcolor="#FEFCAB"><span class="text">##WWORK_DROP##</span></td>
      <td bgcolor="#FEFCAB">&nbsp;</td>
      <td bgcolor="#FEFCAB"><span class="text">##WLOCATION_DROP##</span>
      <td width="87" bgcolor="#FEFCAB">##WSTARTTIMEHOUR##</td>
      <td width="87" bgcolor="#FEFCAB">##WSTARTTIMEMIN##</td>
      <td height="4" bgcolor="#FEFCAB"><span class="style7"></span></td> <!--vmesna kolona za boljši pregled  stop cas-->
      <td width="87" bgcolor="#FEFCAB">##WSTOPTIMEHOUR##</td>
      <td width="87" bgcolor="#FEFCAB">##WSTOPTIMEMIN##</td>
      <td height="4" bgcolor="#FEFCAB"><span class="style7"></span></td> <!--vmesna kolona za boljši pregled  stop cas-->
