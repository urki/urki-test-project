...
<form action="add_work_emplo.php" method="post" accept-charset="utf-8">
  <table width="448" border="0" cellpadding="0" cellspacing="0">
   ...
   <tr>
      <td width="131"  bgcolor="#FEFCAB"><span class="style6"></span></td>
      <td width="4"    bgcolor="#FEFCAB">&nbsp;</td>
      <td width="163"  bgcolor="#FEFCAB"><span class="style6"></span></td>
      <th  width="4"    bgcolor="#FEFCAB" colspan="2"><span class="style6">&#269;as za&#269;etka:</span></th>
      <th  bgcolor="#FEFCAB"><span class="style7">hur</span></th> <!--vmesna kolona za boljši pregled  stop cas-->
      <th  width="4"    bgcolor="#FEFCAB" colspan="2"><span class="style6">&#269;as konca:</span></th>
      <td  bgcolor="#FEFCAB"><span class="style7">hmi</span></td> <!--vmesna kolona za boljši pregled  stop cas-->
      <td  bgcolor="#FEFCAB"><span class="style7"></span></td> <!--vmesna kolona za boljši pregled  stop cas-->
      <td            bgcolor="#FEFCAB">&nbsp;</td>
      <td               bgcolor="#FEFCAB"><span class="style6"></span></td>
      <td               bgcolor="#FEFCAB"><span class="style6"></span></td>
    </tr>
    <tr>
