...
<form action="aktivnosti.php" method="post" accept-charset="utf-8">
  ...
  <table  border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td bgcolor="#FFFED2"  colspan="7" <span class="style6"></span></td>
        ...
        <td bgcolor="#FFFED2"><span class="style6">  </span></td>  <!--vmesna kolona za boljši pregled -->
        <td bgcolor="#FFFED2"  colspan="2" <span class="style6">čas neaktivnega dela:</span></td>
        <td bgcolor="#FFFED2"><span class="style6">  </span></td>  <!--vmesna kolona za boljši pregled -->
    </tr>

   <tr>
     <td bgcolor="#FFFED2"  colspan="1" <span class="style6">ur:</span></td>
       ##IF_ADMIN##
